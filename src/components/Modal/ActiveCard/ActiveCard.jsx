...
function ActiveCard() {
  ...
  // func gọi API dùng chung cho các trường hợp update card title, description, cover, comment,...
  ...
  // Dùng async/await ở đây để component con CardActivitySection chờ. Nếu thành công thì mới clear thẻ input comment
