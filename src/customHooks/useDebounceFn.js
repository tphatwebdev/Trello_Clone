...
export const useDebounceFn = (fnToDebounce, delay = 500) => {
  ...
  // Bọc cái thực thi debounce từ lodash vào useMemo để tránh re-render nhiều lần, mà chỉ re-render khi fnToDebounce hoặc delay thay đổi (như bài hướng dẫn ở trên)
